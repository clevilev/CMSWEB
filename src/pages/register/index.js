...
const Register = () => {
  ...
  const handleSubmit = async e => {
    ...
    try {
      const response = await axios.post('http://localhost:8080/create_camp/', formData) // Replace '/api/your-endpoint' with your API endpoint
          ...
          <Box sx={{ width: '100%', maxWidth: 400 }}>
            ...
            <form noValidate autoComplete='off' onSubmit={handleSubmit}>
              ...
              <CustomTextField
                ...
                placeholder='tennis_camp, football_camp, swimming_camp'
              />
              <CustomTextField
                autoFocus
                name='adminName'
